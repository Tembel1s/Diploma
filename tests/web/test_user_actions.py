...
import requests
from Models.pages.web.user_actions_page import FoodSearch, AddFood, DeleteFood, CaloriesCount
...
def get_cookies():
    ...
    response = requests.post('https://www.fatsecret.com/Auth.aspx?pa=s', data=form_data, headers=headers,
...
def test_calories_count():
    ...
    time.sleep(2)
    calories_count.check_correct_calories_quantity_in_header(product_1_calories_quantity)

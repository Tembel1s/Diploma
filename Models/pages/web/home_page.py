...
class HomePage:
    ...
    def check_my_fatsecret_tab(self):
        ...
        browser.element('[title="My FatSecret"]').element('..').should(have.css_class("highlight"))
    ...
    def check_foods_tab(self):
        ...
        browser.element('[title="Foods"]').element('..').should(have.no.css_class('highlight'))
    ...
    def check_recipies_tab(self):
        ...
        browser.element('[title="Recipes"]').element('..').should(have.no.css_class('highlight'))
    ...
    def check_challenges_tab(self):
        ...
        browser.element('[title="Challenges"]').element('..').should(have.no.css_class('highlight'))
    ...
    def check_fitness_tab(self):
        ...
        browser.element('[title="Fitness"]').element('..').should(have.no.css_class('highlight'))
    ...
    def check_community_tab(self):
        ...
        browser.element('[title="Community"]').element('..').should(have.no.css_class('highlight'))
